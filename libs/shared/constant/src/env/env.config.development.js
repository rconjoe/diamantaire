/**
 * The vrai test instance is here: https://vrai-test.myshopify.com/
 *
 * To connect to the vrai test instance, use
 * const shopifyConfig = require('./env.shopify.vrai-test');
 */
// TODO: Are we going to get throttled when we switch to presentment prices?
...
const diamondFoundryConfig = require('./env.diamondFoundry.development');
const datoConfig = require('./env.dato.development');

const HOST = 'localhost:3000';

/**
 * GTM container id for testing locally
 */

// const GTM_CONTAINER_ID = 'GTM-KK5KX69';

/**
 * This is a test key. Emails are only visible through the Mandrill UI.
 * See https://mandrillapp.com/activity
 */

const MANDRILL_API_KEY = 'AnET7V-S5Ls4cEmo_SPb0Q';

const PREVENT_BASIC_SSR_CACHE = true; // toggle this to enable/disable SSR cache locally
const PREVENT_REDIRECT_HOME_TRY_ON = true;
const PREVENT_JEWELRY_PRODUCT_REDIRECT = false;

/**
 * These are real credentials tied to evan@diamondfoundry.com,
 ...
 *
 * 212.21.66.6 = Berlin, Germany
 * 37.44.128.0 = Oslo, Norway
 * 5.182.128.0 = Copenhagen, Denmark
 * 51.89.191.147 = London, United Kingdom
 * 2.23.112.0 = Greece
 * 3.96.0.1 = Canada
 */
const FAKE_EU_LOCATION_ENABLED = false;
const FAKE_EU_IP_ADDRESS = '5.182.128.0';

/**
 * The domain from which to load diamond videos
 * staging = s3.amazonaws.com/test.videos.diamondfoundry.com
 * production = videos.diamondfoundry.com
 */

const DIAMOND_VIDEO_DOMAIN = 'videos.diamondfoundry.com';

const CMS_TTL_SECS = 60;
const CMS_REFRESH_TIME_SECS = 0; // Raise this above 0 to enable Dato cache warming locally.

const DEFAULT_TTL_SECS = 300;
const DEFAULT_REFRESH_TIME_SECS = 0;
 ...
 * These configs will allow that to be disabled.
 */
const PREVENT_SUBDOMAIN_LINKING = true;
const COOKIE_PREFIX = 'dev.';
