const AsscherIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 59 59" role="img">
      <title>Asscher</title>
      <defs></defs>
      <path
        style={{ fill: '#231f20;' }}
      ...
      ></rect>
      <polygon style={{ fill: '#231f20;' }} points="47.02 19.78 46.77 19.35 58.38 12.68 58.63 13.12 47.02 19.78"></polygon>
      <rect
        style={{ fill: '#231f20;' }}
        x="36.26"
        y="6.08"
      ...
      ></rect>
      <polygon style={{ fill: '#231f20;' }} points="46.15 58.63 39.48 47.09 39.92 46.84 46.58 58.38 46.15 58.63"></polygon>
      <rect
        style={{ fill: '#231f20;' }}
        x="15.78"
        y="-0.42"
