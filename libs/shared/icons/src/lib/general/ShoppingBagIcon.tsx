...
C30.6,10,30.6,9.8,30.4,9.6z M14.6,8.1c0-1.6,0.9-2.9,2.1-3.7c1.3-0.8,2.9-0.8,4.4,0c1.4,0.8,2.1,2.2,2.1,3.7v1.1h-8.7L14.6,8.1z
M28.8,11.1v20.3H9.2V11.1H28.8z"
      />
    </svg>
  );
};
