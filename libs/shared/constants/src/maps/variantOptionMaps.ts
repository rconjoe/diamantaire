...
export const CARAT_FRACTION_OPTIONS = ['1/10ct', '1/4ct', '1/3ct', '2/5ct', '1/2ct', '3/4ct', '1ct', '1½ct', '2ct'];
...
export const PRICE_RANGE_OPTIONS = ['below-500', '500-1500', '1500-3000', '3000-plus', 'custom'];
