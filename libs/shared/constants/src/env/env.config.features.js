...
const datoConfig = require('./env.dato.staging');

const HOST = 'https://features.vrai.com';
...
/**
 * The cache expiry for diamonds is 50 minutes (3,000 seconds), but the cache warmer
 * will refresh at 1/10th that duration, 5 minutes (300 seconds). This cache refresh
 ...
 */
const DIAMOND_COLLECTION_TTL_SECS = 3000;
const DIAMOND_COLLECTION_REFRESH_TIME_SECS = 300;
...
const COOKIE_PREFIX = 'features.';
const ENV_SUBDOMAIN = 'features';
